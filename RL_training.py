...
if __name__=="__main__":
    ...
    Encoder.to(device)
    pretrain_Encoder = torch.load('save/LEX_MAE_retriever_loss_6.8032.pt', map_location='cpu')['dec_model_state_dict']
    ...
    Encoder.model.load_state_dict(pretrain_Encoder, strict=True)
